...
Walk A Mile Game is a interactive game where players can step in to the shoes of an international students moving aboard. In the game players use energy to complete required tasks. Check project [wiki](https://github.com/WalkAMileGame/WalkAMileGame/wiki) for more details.
## Installation
